        ...
        <form className = "flex flex-col gap-5" onSubmit = {onSubmit}>
            ...
            <div className ="flex flex-col md:flex-row gap-5">
                <label className = "text-gray-700 text-sm font-bold flex-1">
                    Firt Name
                    <input className ="bordder rounded w-full py-1 px-2 font-normal"{...register("firstName",{required: "This field is required"})}></input>
                    {errors.firstName && (
                ...
                <label className = "text-gray-700 text-sm font-bold flex-1">
                    Last Name
                    <input className ="bordder rounded w-full py-1 px-2 font-normal" {...register("lastName",{required: "This field is required"})}></input>
                    {errors.lastName && (
